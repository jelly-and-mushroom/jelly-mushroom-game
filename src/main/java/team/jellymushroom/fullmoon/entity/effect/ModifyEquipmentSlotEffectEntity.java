...
@Data
public class ModifyEquipmentSlotEffectEntity extends EffectEntity {
  ...
  public void execute(PlayerEntity ownerPlayer, PlayerEntity opponentPlayer) {
    ...
    int wish = player.getInitEquipmentSlotSize() + this.modifyValue;
    if (wish < 0) {
      wish = 0;
    }
    player.setInitEquipmentSlotSize(wish);
  }
}
