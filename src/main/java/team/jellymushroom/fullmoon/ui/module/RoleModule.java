...
public class RoleModule extends Module {
  ...
  public RoleModule(UIResourceEntity resource, int oX, int oY, int oWidth, int oHeight, int padding, GameRoleEnum gameRoleEnum) {
  ...
  public void draw(Graphics g) {
    super.drawWindow(g);
    BufferedImage roleImg = this.resource.getGameRoleImgMap().get(gameRoleEnum);
